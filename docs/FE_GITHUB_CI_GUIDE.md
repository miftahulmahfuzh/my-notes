...
- Current: 11 tests in CI (`iconRendering.test.tsx`, `LoginForm.test.tsx`, `NoteEditor.test.tsx`, `config.test.ts`, `contentUtils.test.ts`, `markdown.test.ts`, `auth.test.ts`, `api.test.ts`, `PopupApp.test.tsx`, `background/index.test.ts`, `NoteView.test.tsx`)
